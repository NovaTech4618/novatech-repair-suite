    ...
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <div className="flex items-center gap-3 px-2 py-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-teal-600 font-heading font-bold text-white shadow-sm shadow-teal-600/20">
            N
          </div>
              ...
              {navItems.map((item) => (
                <SidebarMenuItem key={item.url}>
                  <SidebarMenuButton
                    ...
                    className="h-10 rounded-xl text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-950 data-[active=true]:bg-teal-50 data-[active=true]:font-semibold data-[active=true]:text-teal-700 data-[active=true]:shadow-none"
                  >
          ...
          {canManageStaff && (
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                className="h-10 rounded-xl text-slate-600 hover:bg-slate-100 hover:text-slate-950 data-[active=true]:bg-teal-50 data-[active=true]:text-teal-700"
              >
