    ...
    <AppLayout>
      <div className="mx-auto w-full max-w-[1500px] space-y-6 p-0">
        <header className="flex flex-col gap-4 border-b border-slate-200 pb-5 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link href="/repairs" className={`inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-lg bg-[#12b76a] px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#087443] ${focusRing}`}>
            <Plus className="size-4" aria-hidden="true" /> New repair
          </Link>
        </header>
