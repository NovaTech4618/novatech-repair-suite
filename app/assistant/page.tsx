...
const suggestions = ["Give me a complete business summary for today.", "Which repairs are delayed and why?", "Which stock items are likely to run out soon?", "Who owes us the most money?", "Compare engineer workload and parts accountability.", "What are my biggest business risks right now?"];
const welcomeMessage: Message = { role: "assistant", text: "Welcome to NOVATECH Premium Intelligence. Ask me questions about your workshop in normal language — performance, repairs, stock, customers, engineers, sales, debt, services, trends and business risks." };
